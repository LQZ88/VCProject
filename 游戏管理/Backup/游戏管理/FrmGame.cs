...
namespace 游戏管理
{
    public partial class FrmGame : Form
    {
        ...
        private void FrmGame_Shown(object sender, EventArgs e)
        {
            ...
            string sql = "select id 'ID',gamename '游戏名',gametype '游戏类别',jiamengshang '加盟商',shoru '与收入' from gameinfo";
        ...
        {
            string sql = "select id 'ID',gamename '游戏名',gametype '游戏类别',jiamengshang '加盟商',shoru '与收入' from gameinfo where gamename like '%" + txtName.Text.Trim() + "%'";
            MySqlConnection con = getConnection();
            MySqlCommand command = new MySqlCommand(sql, con);
            MySqlDataAdapter sda = new MySqlDataAdapter(command);
            /*
        ...
        {
            string sql = "select id 'ID',gamename '游戏名',gametype '游戏类别',jiamengshang '加盟商',shoru '与收入' from gameinfo where gametype like '%" + txtType.Text.Trim() + "%'";
            MySqlConnection con = getConnection();
            MySqlCommand command = new MySqlCommand(sql, con);
            MySqlDataAdapter sda = new MySqlDataAdapter(command);
            /*
        ...
        {
            string sql = "select id 'ID',gamename '游戏名',gametype '游戏类别',jiamengshang '加盟商',shoru '与收入' from gameinfo where jiamengshang like '%" + txtGMS.Text.Trim() + "%'";
            MySqlConnection con = getConnection();
            MySqlCommand command = new MySqlCommand(sql, con);
            MySqlDataAdapter sda = new MySqlDataAdapter(command);
            /*
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@shoru", 10000);
            /*
            SqlConnection con = getConn();
        ...
        {
            string sql = "update gameinfo set gamename=@name,gametype=@type,jiamengshang=@gms where id=@id";
            MySqlConnection con = getConnection();
            MySqlCommand cmd = new MySqlCommand(sql, con);
            cmd.Parameters.AddWithValue("@name", txtName.Text.Trim());
            cmd.Parameters.AddWithValue("@type", txtType.Text.Trim());
