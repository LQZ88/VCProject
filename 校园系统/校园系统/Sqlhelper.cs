...
namespace School
{
    class Sqlhelper
    {
        ...
        {
            MySqlConnection con = new MySqlConnection("server=localhost;user id=root; password=root; database=SchoolRun; pooling=false");
            try
            {
                con.Open();
            }
        ...
        {
            MySqlConnection con = Sqlhelper.getCon();
